...
// this is our sass/css loader. It handles files that are require('something.css')
const styles = {
  test: /\.(scss)$/,
  // here we pass the options as query params because it's short.
...
const config = {
  ...
  // remember we said webpack sees everything as modules and how different loaders are responsible for different file types? Here is where we implement them. Pass it the rules for our JS and our styles
  module: {
...
// webpack is cranky about some packages using a soon to be deprecated API. shhhh
